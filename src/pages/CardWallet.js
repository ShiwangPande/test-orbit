                ...
                <div className=" mt-36 mx-5 grid grid-cols-1 lg:mt-20 lg:grid-cols-2 gap-3 lg:gap-10">
                    {submittedData.map((data, index) => (
                        ...
                        data?.selectedLedgerName && (
                            <div key={index} className=" flex flex-col mt-10 justify-between lg:max-w-3xl max-w-sm lg:p-6 p-2 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
